...
class Card_poker extends StatefulWidget {
  @override
  _Card_pokerState createState() => _Card_pokerState();
}

class _Card_pokerState extends State<Card_poker> {
    ...
    return
      MaterialApp(
        ...
        home: SafeArea(
          ...
          body: Padding(
            padding: const EdgeInsets.fromLTRB(2.0, 5.0,2.0, 8.0),
            child: Column(
              ...
              children: [
                ...
                Text('Fibonacci Cards',style: TextStyle(
